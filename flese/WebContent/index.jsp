...
<br>
	...
	<p align="justify">Flese is a framework allowing the
		final user to perform fuzzy queries (as "fast red car") in databases
		that might have no fuzzy information at all.</p>
	
	<h2><center>FleSe in detail</center></h2>
	<p align="justify">
		Flese is a framework composed by two sub-frameworks: the engine that
		processes fuzzy queries and the web interface that presents results in
		a human-readable way.<br>
		The engine is an improved version of the framework Rfuzzy
				presented in <a
				href="http://www.sciencedirect.com/science/article/pii/S0020025510003610">&ldquo;RFuzzy:
					Syntax, semantics and implementation details of a simple and
					expressive fuzzy tool over Prolog&rdquo;</a>. In this new framework we
				...
				programming environment.
			<br>
			The web interface is a Java application that interprets the
				answers provided by the fuzzy framework. It runs on a Tomcat server
...
<div class="footer">
	...
	<a href="http://www.micinn.es/"> <img height="80"
			src="images/logo-micinn.png"
			alt="logo Ministerio de Ciencia e Innovación"></img></a>
			
	<a href="http://www.madrid.org/"> <img height="80" width="80"
			src="images/madrid.png" alt="logo Comunidad de Madrid"></img></a>
	...
	alt="logo Departamento de Lenguajes y Sistemas Informáticos e Ingeniería del Software"></img></a> 
	 ...
	 <a href="http://mcyt.es/"> <img height="80" width="250"
			src="images/logo6.gif"
			alt="logo Ministerio de Ciencia y Tecnología"></img>
		</a>
	</div>
</div>
