...
public class KConstants {
	...
	public static class PathsMgmt {
		...
		public static String rbScriptPath = "";
		...
		try {
			...
			rbScriptPath = prop.getProperty("rbScriptPath");
	...
	public static class JspsDivsIds {
		...
		public static final String convertToProlog = "convertToProlog";
		...
		public static final String fuzzificationUpdateStatusDivId = "fuzzificationUpdateStatus";
		
		public static final String fuzzificationSimilarityColumnDivId = "fuzzificationSimilarityColumn";
		public static final String fuzzificationSimilarityValueId = "fuzzificationSimilarityValue";
		public static final String fuzzificationSaveSimilarityId = "fuzzificationSaveSimilarity";
	}
